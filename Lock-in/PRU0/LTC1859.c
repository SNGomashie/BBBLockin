...
int16_t LTC1859transfer(uint16_t spi_word){
...
int16_t LTC1859readout(uint8_t chan, uint8_t mode){
  ...
  switch(mode){
    case 0:
      SPIsend = (ADCch[chan] << 12) | 0b1000000000000000; // single-ended, input +/-5V
      break;
    case 1:
      SPIsend = (ADCch[chan] << 12) | 0b1000100000000000; // single-ended, input 0V to 5V
      break;
