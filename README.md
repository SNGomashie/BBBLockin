...
3. [Programming the PRU](#programming-the-pru)
   ...
   - [Examples](#running-our-first-program)
     1. [PRU-ICSS python module](https://github.com/SNGomashie/BBBLockin/tree/master/Python/PRU-ICSS)
     2. [GPIO](https://github.com/SNGomashie/BBBLockin/tree/master/GPIO)
     3. [RPMSG](https://github.com/SNGomashie/BBBLockin/tree/master/RPMsg)
     4. [IEP INTC](https://github.com/SNGomashie/BBBLockin/tree/master/Cycle_test)
     5. [ADC](https://github.com/SNGomashie/BBBLockin/tree/master/ADC)
     6. [eCAP](https://github.com/SNGomashie/BBBLockin/tree/master/eCAP)
     7. [UART](https://github.com/SNGomashie/BBBLockin/tree/master/UART)
     8. [McSPI LTC1859](https://github.com/SNGomashie/BBBLockin/tree/master/McSPI_LTC1859)
4. [Simulating a Lock-in Amplifier](https://github.com/SNGomashie/BBBLockin/tree/master/Python/Simulations)
5. [Generating Sine/Cosine with an NCO](https://github.com/SNGomashie/BBBLockin/tree/master/NCO)
...
- [x] Compile first firmware for PRU-ICSS
- [x] Use PRU-ICSS GPIO
- [x] Access PRU-ICSS Memory
- [x] Communicate with ARM processor using RPMsg
- [x] Read first message from RPMsg on ARM using python
- [x] Write python module for controlling and communicating with PRU-ICSS
- [x] Interrupt and send messages between PRU cores
- [x] Use the IEP timer
- [x] Use the AM335x on-board ADC
- [x] Use the MAC
- [x] Measure periods using the eCAP module
- [x] Send messages to computer using UART
- [x] Use the McSPI module to sample the LTC1859
- [x] Determine sample frequency required for lock-in
- [x] Implement Numerically controlled oscillator
- [x] Implement lock-in amplifier on the PRU
...
1. [PRUlib](https://github.com/SNGomashie/BBBLockin/tree/master/Python/PRU-ICSS) - A python module for the PRUs
2. [GPIO](https://github.com/SNGomashie/BBBLockin/tree/master/GPIO) - Blink the onboard LED or toggle a pin
