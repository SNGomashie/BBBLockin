...
//   if(index < QSIZE){
//     return sinLUT[index];
//   } else if(index >= QSIZE && index < HSIZE){
//     return sinLUT[(HSIZE - 1) - index];
//   } else if(index >= HSIZE && index < TQSIZE){
//     return -sinLUT[index - HSIZE];
//   } else if(index >= TQSIZE && index < LUTSIZE){
//     return -sinLUT[(LUTSIZE - 1) - index];
